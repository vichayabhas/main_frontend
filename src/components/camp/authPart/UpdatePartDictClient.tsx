...
import { GetPartDictForUpdate, Id, InterCampDict } from "../../../../interface";
...
export default function UpdatePartDictClient({
  data,
  token,
}: {
  data: GetPartDictForUpdate;
  token: string;
}) {
