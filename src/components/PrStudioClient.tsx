...
import { downloadText, setSwop, setSwop2DimensionArray } from "./setup";
...
export default function PrStudioClient({
  ...
  const [campSongIds, setCampSongIds] = useState(camp.songIds);
  const [arrayOfBaanSongLists, setArrayOfBaanSongLists] = useState(
