...
export default function UpdateCampClient({
  ...
  const [camp, setCamp] = useState(campIn);
  const [pusherData, setPusher] = useState(pusherDataIn);
  const [parts, setParts] = useState(partIns);
  ...
  const [arrayOfAuthPartList, setArrayOfAuthPartList] = useState<boolean[][]>(
